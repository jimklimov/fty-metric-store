...
#   if defined FTY_METRIC_STORE_STATIC
#       define FTY_METRIC_STORE_EXPORT
#   elif defined FTY_METRIC_STORE_INTERNAL_BUILD
#       if defined DLL_EXPORT
#           define FTY_METRIC_STORE_EXPORT __declspec(dllexport)
#       else
#           define FTY_METRIC_STORE_EXPORT
#       endif
#   elif defined FTY_METRIC_STORE_EXPORTS
#       define FTY_METRIC_STORE_EXPORT __declspec(dllexport)
#   else
#       define FTY_METRIC_STORE_EXPORT __declspec(dllimport)
#   endif
#   define FTY_METRIC_STORE_PRIVATE
#elif defined (__CYGWIN__)
#   define FTY_METRIC_STORE_EXPORT
#   define FTY_METRIC_STORE_PRIVATE
#else
#   if (defined __GNUC__ && __GNUC__ >= 4) || defined __INTEL_COMPILER
#       define FTY_METRIC_STORE_PRIVATE __attribute__ ((visibility ("hidden")))
#       define FTY_METRIC_STORE_EXPORT __attribute__ ((visibility ("default")))
#   else
#       define FTY_METRIC_STORE_PRIVATE
#       define FTY_METRIC_STORE_EXPORT
#   endif
...
typedef struct _fty_metric_store_server_t fty_metric_store_server_t;
#define FTY_METRIC_STORE_SERVER_T_DEFINED
