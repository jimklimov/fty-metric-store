...
git clone --quiet --depth 1 -b release/IPM-2.0.1 https://github.com/42ity/fty-proto.git fty-proto
...
git clone --quiet --depth 1 -b release/IPM-2.0.1 https://github.com/42ity/fty-shm.git fty_shm
cd -
